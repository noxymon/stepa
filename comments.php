...
<?php if ( have_comments() ) : ?>
        ...
        <h2 class="comment-title" id="comments">
            <?php comments_number(__('No Responses','html5reset'), __('One Response','html5reset'), __('% Responses','html5reset') );?>
        </h2>
...
<div id="respond">
    ...
    <?php else : ?>
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <div>
                <textarea placeholder="type your comment..." class="form-control comment-control" name="comment" id="comment" cols="58" rows="10" tabindex="4"></textarea>
            </div>
            <div style="margin-top: 10px;">
                <button class="btn btn-primary" name="submit" type="submit" id="submit" tabindex="5"><?php _e('Submit Comment','html5reset'); ?></button>
